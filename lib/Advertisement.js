...
Advertisement.prototype._getDefaultID = function () {
  ...
  return new Promise(function (resolve, reject) {
    ...
    self._defaultAddresses = _this5._customInterfaces.map(function (intf) {
      return {
        address: intf,
...
Advertisement.prototype._advertiseHostname = function () {
  ...
  var bridgeable = (_ref = []).concat.apply(_ref, _toConsumableArray(interfaces.map(function (i) {
...
Advertisement.prototype._makeAddressRecords = function (addresses) {
  ...
  var As = addresses.filter(function (_ref2) {
  ...
  var AAAAs = addresses.filter(function (_ref4) {
